...
public class BillEmail {
    ...
    public static String billEmail(UserDTO user, OrderDTO order, int quantity) {
        ...
        String billDetail = "<!DOCTYPE html>\n"
                ...
                + "                    <p class=\"title-order spec\">Kính gửi quý khách hàng: " + user.getUserName() +"</p>\n"
                ...
                + "                                </td>\n"
                + "                                <td class=\"w-75\"><span class=\"table-content-customer font-size\">"+user.getUserName()+"</span></td>\n"
                + "                            </tr>\n"
                + "                            <tr>\n"
                ...
                + "                                <td><span class=\"table-content-customer font-size\">"+order.getPhoneNumber()+"</span></td>\n"
                + "                            </tr>\n"
                + "                            <tr>\n"
                + "                                <td class=\"w-25 row-table-customer\"><span class=\"table-info-customer font-size\">Địa Chỉ</span></td>\n"
                + "                                <td class=\"\"><span class=\"table-content-customer font-size\">"+order.getLocation()+"</span></td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
                + "                    </div>\n"
