...
<body>
                                        ...
                                        <div class="col-md-12 p-0">
                                            <table class="w-100 table-body">
                                                <tr class="table-header">
                                                    <td class="p-3 px-4"><span class="float-start">ProductID</span></td>
                                                    <td class="p-3 px-4 "><span class="float-start">Name</span></td>
                                                    <td class="p-3 px-4 "><span class="float-start">Type</span></td>
                                                ...
                                                <tr class="table-content">
                                                    ...
                                                    <td class="p-3 px-4 "><span>4.5</span></td>
                                                    <td class="w-10">
                                                        <div class="img-product">
                                                            <img src="https://cdn.discordapp.com/attachments/1202620106140680202/1209469151865737266/image_1.png?ex=65e708ec&is=65d493ec&hm=6bc26e41387e3c9a363f9692c932d4ac107c5154d318235bfa8f3063fcdec641&" alt="">
                                                        </div>
                                                    </td>
                                                    <td class="p-3 px-4 description-product"><span>Một sự pha trộn độc đáo của hoa tulip trắng, tím và cam được tô điểm thêm bởi sự lựa chọn hấp dẫn của hương vani thơm ngon, quả chanh hồ trăn và bánh hạnh nhân sô cô la.</span></td>
                                                ...
                                                <tr class="table-content">
                                                    <td class="p-3 px-4 "><span class="float-start">B005</span></td>
                                                    <td class="p-3 px-4 "><span class="float-start">Wild</span></td>
                                                    <td class="p-3 px-4 "><span class="float-start">Box</span></td>
                                                    <td class="p-3 px-4 "><span>10</span></td>
                                                    <td class="p-3 px-4 "><span class="float-start">250.000</span></td>
    ...
    <script>
        ...
        function addfloat(a) {
                var input = document.getElementById(a);
                if (parseFloat(input.value) < 5) {input.value = parseFloat(input.value) + 0.5;}
            }
    </script>
</body>
