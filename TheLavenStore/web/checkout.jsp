                        ...
                        <div class="w-100">
                            <div class="profile-info w-100 d-flex justify-content-center">
                                <table class="w-75">
                                    ...
                                    <tr>
                                        <td class="py-1"><input type="text" name="" id="" placeholder="Fullname" value="${sessionScope.account.fullName}"
                                                                class="w-100 p-1 ps-2 nochange" readonly></td>
                                    </tr>
                                    <tr>
                                        <td class="py-1"><input type="text" name="" id="" placeholder="Email" value="${sessionScope.account.email}"
                                                                class="w-100 p-1 ps-2 nochange" readonly></td>
                                    </tr>
                                    <tr>
                                        <td class="py-1"><input type="text" name="" id="" placeholder="Mobile Phone" value="${sessionScope.account.phoneNumber}"
                                                                class="w-100 p-1 ps-2"></td>
                                    </tr>
                                    <tr>
                                        <td class="py-1"><input type="text" name="" id="" placeholder="Address" value="${sessionScope.account.address}"
                                                                class="w-100 p-1 ps-2"></td>
                                    </tr>
                                    <tr>
                                        <td class="py-1"><textarea name="" id="" cols="30" rows="3" placeholder="Note"
                                ...
                                <table class="w-100">
                                    ...
                                    <c:forEach items="${requestScope.cartList.items}" var="o">
                                        <tr>
                                            ...
                                            <td class="py-1 text-center w-15"><span class="Dongle text-center" style="color: #FF0000;"></span></td>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div>
                            ...
                            <div class="w-80 px-4 py-3 d-flex flex-column justify-content-center payment-choose">
                                ...
                                <div class="w-100 d-flex flex-column justify-content-center">
                                    <div class="payment w-100 d-flex justify-content-between pe-2" onclick="checkradio('vnpay')" style="cursor: pointer;">
                                        ...
                                        <input type="radio" name="payment" id="vnpay" class="float-end">
                                    </div>
                                    <div class="mt-3 payment w-100 d-flex justify-content-between pe-2" onclick="checkradio('cod')" style="cursor: pointer;">
                                        ...
                                        <input type="radio" name="payment" id="cod" class="float-end">
                                    </div>
                                </div>
