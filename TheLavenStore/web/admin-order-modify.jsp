                    ...
                    <div class="box-item w-75 p-3">
                        ...
                        <table class="w-100 table-modal">
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="p-2"><input type="text" name="" id="" class="w-50 ps-2 py-1" value="${requestScope.order.phoneNumber}"></td>
                            </tr>
                            <tr>
                                <td class="p-2">Location: </td>
                                <td colspan="3" class="p-2"><input type="text" name="" id="" class="w-100 ps-2 py-1" value="${requestScope.order.location}"></td>
                            </tr>
                        </table>
                        ...
                        <div class="footer-modal py-4 d-flex justify-content-end">
                            <div class="close me-4">
                                <div class="modal-btn-close p-2 px-4"><span>Close</span></div>
                            </div>
